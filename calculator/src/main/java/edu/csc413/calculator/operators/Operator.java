...
public abstract class Operator {
    ...
    private static HashMap<String, Operator> operatorsymbols;
    static {
        operatorsymbols = new HashMap<String, Operator>();
        operatorsymbols.put("+", new AddOperator());
        operatorsymbols.put("-", new SubtractOperator());
        operatorsymbols.put("*", new MultiplyOperator());
        operatorsymbols.put("/", new DivideOperator());
        operatorsymbols.put("^", new PowerOperator());
    ...
    public static boolean check(String token) {
        ...
        Set<String> keys = operatorsymbols.keySet();
        for(String key: keys){
            if(token.equals(key)) {
                result = true;
                break;
    ...
    public static HashMap<String, Operator> get(){
